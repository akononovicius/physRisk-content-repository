...
Use the app below to explore the four of the noisy voter model with
supportive interactions, which prevent only recruitment transitions. This app
plots the time series generated by the model. We plot time series, because in
most cases this model will quite quickly find stable stationary point.
We will revisit statistical analysis of the time series in a later post.
